import  { SectionHeader, Course }  from "../components";
    ...
    return <section>
        <div className="container">
            <div className="flex flex-col gap-y-24">
                ...
                <motion.div variants={centerVariants} initial='hidden' whileInView='visible' viewport={{margin: '0px 0px -200px 0px', once: true}} className="flex flex-col items-center">
                    <div className="flex items-center px-6 w-[calc(100%-1.5rem)] overflow-auto">
                         {
                            categories.map((item, index) => {
                                return <div onClick={() => handleCategory(item)} key={index} className={`group flex items-center justify-center px-8 py-6 min-w-[120px] bg-white rounded-t-4xl hover:bg-gray-30 [&:is(.active)]:!bg-gray-10 cursor-pointer transition-colors duration-300 ${activeCategory === item ? 'active' : ''}`}>
