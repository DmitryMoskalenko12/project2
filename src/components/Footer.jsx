                ...
                <div className="flex flex-col">
                   <div className="flex items-start justify-between flex-wrap gap-8">
                    ...
                    <div className='footer-col'>
                        ...
                        <div className='flex flex-col gap-y-2'>
                           <a href="#" className='footer-link'>Address: Mykolaiv</a>
                           <a href="mailto:dmtrmsklnk@gmail.com" className='footer-link'>Email: dmtrmsklnk@gmail.com</a>
                           <a href="tel:0996117693" className='footer-link'>Phone: 099 611 7693</a>
                        </div>
                    </div>
                    <div className='footer-col'>
                       <p className='footer-heading'>Subscribe to our Newsletter</p>
                       <form className='flex flex-col gap-y-4'>
                        <input type="text" autoComplete='off' placeholder='Enter Your Email' className='outline-0 rounded-2xl h-14 px-1.5 bg-gray-20 text-base font-medium text-white'/>
                   ...
                   <div className='flex justify-between flex-wrap gap-4 p-10 mt-[70px] bg-gray-20 rounded-4xl'>
                        <p className='text-lg text-gray-80'>
                            &copy; 2024 <span className='text-primary-50'>Coursat.</span> All rights reserved.
                        </p>
