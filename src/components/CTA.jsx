...
const Cta = () => {
    return <motion.div variants={centerVariants} initial='hidden' whileInView={{margin: '0px 0px -200px 0px', once: true}} className="py-[70px]">
            <div className="container h-[400px]">
                <div className="flex flex-col justify-center items-center gap-y-8 w-full h-full px-4 bg-[url('/src/assets/ctabg.png')] border border-solid border-gray-10 rounded-4xl">
                    ...
                    <form className="w-full max-w-[550px]">
                        <div className="flex items-center border border-solid border-gray-10 rounded-full h-14 p-1.5 overflow-hidden">
                            <input type="text" name='email' id="email" autoComplete="off" placeholder="Enter Your Email" className="autline-0 bg-transparent px-4 w-full text-base placeholder:text-gray-40"/>
